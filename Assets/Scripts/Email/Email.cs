...
namespace UE.Email
{
    ...
    public static partial class Email
    {
        ...
        [DllImport("__Internal")]
        private static extern void SendMailJS(string serviceID, string templateID, string title, string name, string time, string message, string email);


        public static void SendEmailJS(string serviceID, string templateID, string title, string name, string time, string message, string email)
        {
#if UNITY_WEBGL && !UNITY_EDITOR
            SendMailJS(serviceID, templateID,  title, name, time, message, email);
#else
